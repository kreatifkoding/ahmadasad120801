...
class Kategori(models.Model):
    ...
    banner_dua = models.ImageField(upload_to='gambar/banner', blank=False,
                                   null=True, verbose_name="Gambar Banner (575 x 200 pixel)")
    # banner_satu = ResizedImageField(size=[575, 200], quality=80, crop=[
    #                                 'middle', 'center'], upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar (575 x 200 pixel)")
    # banner_dua = ResizedImageField(size=[575, 200], quality=80, crop=[
    #                                'middle', 'center'], upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar (575 x 200 pixel)")
    ...
    @property
    def get_produk(self):
        return Produk.objects.filter(aktif=True, kategori__nama=self.nama)
...
class Slide(models.Model):
    ...
    gambar_slide = models.ImageField(upload_to='gambar/slide', blank=False,
                                     null=True, verbose_name='Gambar (475 x 800 pixel)')
    aktif = models.BooleanField(default=True)
